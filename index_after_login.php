...
<body>
    <nav class="navbar">
        <ul class="navlist">
            ...
            <!-- <i class="fa-solid fa-cart-shopping" id="navcart"></i> -->
            <div class="cart">
    ...
    <div class="ibody">
        ...
        <div class="imgslider">
            <span id="vou">
                ...
                <div class="voutext"> Use voucher 'KRISHTI30' and get 30TK off on 1kg Deshi ghee !!!!! </div>
            </span>

            <p id="itext"><u>ফিরে আসুক ঐতিহ্য.....</u></p>
            <p id="itext2">Order Now !!</p>
            <p id="itext3">Get discount on authentic products</p>
        </div>
    </div>
    ...
    <p id="cattext">Our Categories</p>
    </div>
    <section>
        <div class="category-row">
            <div class="category-col">

                <a href="pottery.php"> <img src="kimg/catclay.png" alt="Pottery"> </a>
                <h5>Pottery</h5>
            </div>
            <div class="category-col">

                <a href="food.php"><img src="kimg/catghee.png " alt="Food"> </a>
                <h5>Food</h5>
            </div>
            <div class="category-col">

                <a href="clothing.php"><img src="kimg/catsaree - Copy.png" alt="Fabrics"> </a>
                <h5>Fabrics</h5>
            </div>
