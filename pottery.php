    ...
    <section>
        ...
        <div class="common-row col-deals">
            ...
            <div class="common-col">
                <img src="kimg/pclaypotlid.png" alt="" class="product-img">
                <h3 class="product-title">Clay Pot with Lid</h3>
                <h4 class="price">Price:  450TK </h4>
                <i class="fa-solid fa-cart-plus add-cart" ></i>
            </div>

            <div class="common-col">
                <img src="kimg/pclayglass.png" alt="" class="product-img">
                <h3 class="product-title">Clay Water Glass</h3>
                <h4 class="price">Price: 250TK </h4>
                <i class="fa-solid fa-cart-plus add-cart" ></i>
            </div>

            <div class="common-col">
                <img src="kimg/pclayornament.jpg" alt="" class="product-img">
                <h3 class="product-title">Clay Ornaments</h3>
                <h4 class="price">Price: 280TK </h4>
                <i class="fa-solid fa-cart-plus add-cart" ></i>
            </div>
        </div>
        <div class="common-row col-deals">
            <div class="common-col">
                <img src="kimg/pcoinbank.jpg" alt="" class="product-img">
                <h3 class="product-title">Clay Coin-Bank</h3>
                <h4 class="price">Price: 200TK </h4>
                <i class="fa-solid fa-cart-plus add-cart"></i>
            </div>

            <div class="common-col">
                <img src="kimg/plampshade.jpg" alt="" class="product-img">
                <h3 class="product-title">Clay Lampshade</h3>
                <h4 class="price">Price:  560TK </h4>
                <i class="fa-solid fa-cart-plus add-cart"></i>
            </div>

            <div class="common-col">
                <img src="kimg/pShokher_Hari.jpg" alt="" class="product-img">
                <h3 class="product-title">Clay Shokher Hari</h3>
                <h4 class="price">Price: 290TK </h4>
                <i class="fa-solid fa-cart-plus add-cart" ></i>
            </div>
